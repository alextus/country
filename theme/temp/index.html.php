...
<br /><br /><br />
    ...
    <div class="dbt">
        ...
        <a href="javascript:setShowField();">显示字段</a>
    </div>
   ...
   <script>
       ...
       _form.ini(".form",t,{},function(i,n){
           ...
           c=""
           var i50=["zm2" ,"zm2s","zm3","num","tel", "time", "time2","currency","currency2","currency3"], i100 = ["belong", "money", "money2", "continent", "population", "area", "un", "untime","fz","fz2"], ibr = ["zm3", "tel", "time2", "untime", "continent", "population","money2","currency3", "fz2"]
